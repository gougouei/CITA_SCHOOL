  ...
  return (
    <>
      <header className="bg-white border-b border-border px-4 py-4 sm:px-8 sm:py-5">
        ...
        <p className="text-sm text-muted-fg mt-0.5">Échangez avec vos étudiants et vos collègues</p>
      </header>
        ...
        <Card>
          <div className="px-6 py-16 sm:py-20 text-center">
            ...
            <p className="text-muted-fg text-sm max-w-md mx-auto">
              Vous serez ajouté automatiquement aux canaux des classes qui vous sont assignées.
            </p>
          </div>
        </Card>
      </div>
